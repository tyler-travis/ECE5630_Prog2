...
\newcommand{\hmwkAuthorName}{Tyler Travis} % Your name
...
Listing \ref{src/part1} shows Part 1 of the assignment.
Listing \ref{plots/Part1-a-Impulse} shows the the Impulse reponse

\begin{center}
\includegraphics[width=0.75\columnwidth]{plots/Part1-a-Impulse}
\end{center}

\cppscript{src/part1}{Sample Perl Script With Highlighting}
